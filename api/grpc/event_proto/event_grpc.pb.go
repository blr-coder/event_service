...
func (c *eventServiceClient) List(ctx context.Context, in *ListEventsRequest, opts ...grpc.CallOption) (*Events, error) {
	out := new(Events)
...
func (UnimplementedEventServiceServer) List(context.Context, *ListEventsRequest) (*Events, error) {
